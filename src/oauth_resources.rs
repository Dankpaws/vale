// Android compatibility identifiers inherited from the Redlib engine.
// Review changes manually: the former generator scraped mutable third-party
// download pages and could not produce a reproducible, auditable source file.
